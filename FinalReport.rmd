...
This graphic showing us that the drug works, the graph shows that the people who took the placebo are the majority of people overall who got Aids.
...
In this table we can see that results are showing that drug works because the people who took the drug, the percentage is less that the people took placebo.
...
we can see in this case is very clear that the drug in the girls group did not works.
The girls who took the drug got more infected that the girls did took the placebo. the percentage of girls tht took the drugs id higher that the girls took the pacebo.
...
In this graphic we can see that drug did not works for girls. Girls who took the drug, 60% got aids, and the girls who took placebo just 40% got aids. trhe percentege of get aids is higher if you are a girl and take the drug.
...
The drug does not work on the girls group, after we compare the results with all the different tests we define that the drug does not work, in the boys group.The percentage of the boys who took the drug shows lesser pecentage of aids; and the people who took placebo are higher of aids.
  
# Methods for Boys

We will compare the results with Graphical results, NumericalDescriptive results, Inferential results with P-Value and Fisher test.We will make different groups with the data we have with a Male's group.
...
Looks the drug does work on boys, the boys who took the drug had lesser persentage of getting aids. 
