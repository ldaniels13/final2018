...
A new  preventative aides (abacavirinol) is under test in clinical trials. Analyze the effectiveness of this drug across the board. Consider population subgroups by gender, drug use, and sexual orientation. with this project we will deteermine if the drug is working in all diferent groups. First we will determine different groups, in this case we will see if the drug is working in All Group. we compire  the graphic and different results we have in Chisq.test, chisqtestGC and fisher.test.

# Methods for everybody
we will make diferents groups with the data we have,with all, Females, Males, gays, and drug abusers. we will compare the results to determine 
